function bind_missiontable(missionType) {

}

function showmissiontable_byadmin(missionType, tableid, setstring) {
    ...
    $.ajax({
        type: "get",
        url: "http://121.41.27.107:8000/dispatch-mgr/channel" + parastring + "&channelType=2&missionType=" + missionType,
        ...
        success: function (data) {
            bindmissiontable(tableid, setstring, data);
            pageNavBind(data);
        },
...
function showmissiontable_byself(missionType, tableid, setstring) {
    ...
    $.ajax({
        type: "get",
        url: " http://121.41.27.107:8000/dispatch-mgr/mission/own" + parastring + "&missionType=" + missionType,
        contentType: "application/json",
        dataType: "json",
        beforeSend: function (xhr) {
            xhr.setRequestHeader("Authorization", userstoken);
...
function bindmissiontable(tableid, setstring, datajson) {
